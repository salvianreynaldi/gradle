...
public class DependencyStringNotationConverterTest extends Specification {
    def parser = new DependencyStringNotationConverter(DirectInstantiator.INSTANCE, DefaultExternalModuleDependency.class, stringInterner);
    ...
    def "can create client module"() {
        def parser = new DependencyStringNotationConverter(DirectInstantiator.INSTANCE, DefaultClientModule, stringInterner);
